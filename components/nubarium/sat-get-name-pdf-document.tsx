...
interface SatGetNamePDFDocumentProps {
    searchParams: {
        rfc: string;
    };
    result: {
...
export const SatGetNamePDFDocument: React.FC<SatGetNamePDFDocumentProps> = ({
    searchParams,
    result,
}) => {
            ...
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.contentArea}>
                    ...
                    <View style={styles.header}>
                        <Text style={styles.title}>Reporte - Obtener Nombre de RFC</Text>
                    ...
                    <View style={[styles.statusBox, ...(isSuccess ? [styles.statusBoxSuccess] : [styles.statusBoxError])]}>
                        <Text style={styles.statusTitle}>
                            {isSuccess ? '✓ Consulta Exitosa' : '✗ Consulta Fallida'}
                        </Text>
                        <Text style={styles.statusMessage}>
                            {result.mensaje || (isSuccess ? 'Nombre obtenido correctamente' : 'No se pudo obtener el nombre')}
                        </Text>
                    </View>
                    ...
                    {isSuccess && result.razonSocial && (
                        <View style={styles.nameHighlight}>
                            <Text style={styles.nameLabel}>Razón Social / Nombre</Text>
                            <Text style={styles.nameValue}>{result.razonSocial}</Text>
                        </View>
                    )}
                    ...
                    <Text style={styles.footer}>
                        Monitor Judicial - Reporte - Obtener Nombre de RFC
                    </Text>
                </View>
            </Page>
        </Document>
