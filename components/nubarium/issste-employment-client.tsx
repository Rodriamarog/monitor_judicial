...
export function IssssteEmploymentClient({ userId }: { userId: string }) {
    ...
    const handleSearch = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch('/api/investigacion/nubarium/issste/employment', {
                method: 'POST',
    ...
    return (
        <div className="space-y-6 max-w-4xl mx-auto">
            <div>
                <h1 className="text-3xl font-bold">Historial Laboral - ISSSTE</h1>
                <p className="text-muted-foreground">Obtiene historial laboral ISSSTE (webhook)</p>
            </div>
            <Card>
